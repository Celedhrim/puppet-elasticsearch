...
#   elasticsearch_legacy::plugin {'mobz/elasticsearch-head': module_dir => 'head'}
#
# @example installation using a custom URL
#   elasticsearch_legacy::plugin { 'elasticsearch-jetty':
...
define elasticsearch_legacy::plugin (
  ...
  Stdlib::Absolutepath           $configdir      = $elasticsearch_legacy::configdir,
